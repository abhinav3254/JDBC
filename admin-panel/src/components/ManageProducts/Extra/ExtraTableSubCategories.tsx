...
const ExtraTableSubCategories: React.FC<ExtraProps> = ({ data }) => {
        ...
        <div>
            ...
            <div className="card">
                ...
                >
                    ...
                    <Column field="categoryId" header="Category Id" sortable style={{ minWidth: '16rem' }}></Column>
...
export default ExtraTableSubCategories;